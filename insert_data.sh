...
python2 insert_data.py vs/unique_running_insertion.cpp.csv            "No-rehash runnning insertion"               "vs/running insertion.xlsx"             "practice norehash"
python2 insert_data.py vs/unique_running_insertion.cpp.csv            "Runnning insertion"                         "vs/running insertion.xlsx"             "practice"
python2 insert_data.py vs/non_unique_running_insertion.cpp.csv        "No-rehash runnning insertion, Fmax=1, G=5"  "vs/running insertion.xlsx"             "practice norehash non-unique"
python2 insert_data.py vs/non_unique_running_insertion.cpp.csv        "No-rehash runnning insertion, Fmax=5, G=5"  "vs/running insertion.xlsx"             "practice norehash non-unique 5"
python2 insert_data.py vs/non_unique_running_insertion.cpp.csv        "Runnning insertion, Fmax=1, G=5"            "vs/running insertion.xlsx"             "practice non-unique"
python2 insert_data.py vs/non_unique_running_insertion.cpp.csv        "Runnning insertion, Fmax=5, G=5"            "vs/running insertion.xlsx"             "practice non-unique 5"
python2 insert_data.py vs/unique_scattered_erasure.cpp.csv            "Scattered erasure"                          "vs/scattered erasure.xlsx"             "practice"
python2 insert_data.py vs/non_unique_scattered_erasure.cpp.csv        "Scattered erasure, Fmax=1, G=5"             "vs/scattered erasure.xlsx"             "practice non-unique"
python2 insert_data.py vs/non_unique_scattered_erasure.cpp.csv        "Scattered erasure, Fmax=5, G=5"             "vs/scattered erasure.xlsx"             "practice non-unique 5"
python2 insert_data.py vs/non_unique_scattered_erasure_by_key.cpp.csv "Scattered erasure, Fmax=1, G=5"             "vs/scattered erasure by key.xlsx"      "practice non-unique"
python2 insert_data.py vs/non_unique_scattered_erasure_by_key.cpp.csv "Scattered erasure, Fmax=5, G=5"             "vs/scattered erasure by key.xlsx"      "practice non-unique 5"
python2 insert_data.py vs/unique_scattered_lookup.cpp.csv             "Scattered successful lookup"                "vs/scattered successful looukp.xlsx"   "practice"
python2 insert_data.py vs/unique_scattered_lookup.cpp.csv             "Scattered unsuccessful lookup"              "vs/scattered unsuccessful looukp.xlsx" "practice"
python2 insert_data.py vs/non_unique_scattered_lookup.cpp.csv         "Scattered successful lookup, Fmax=1, G=5"   "vs/scattered successful looukp.xlsx"   "practice non-unique"
python2 insert_data.py vs/non_unique_scattered_lookup.cpp.csv         "Scattered unsuccessful lookup, Fmax=1, G=5" "vs/scattered unsuccessful looukp.xlsx" "practice non-unique"
python2 insert_data.py vs/non_unique_scattered_lookup.cpp.csv         "Scattered successful lookup, Fmax=5, G=5"   "vs/scattered successful looukp.xlsx"   "practice non-unique 5"
python2 insert_data.py vs/non_unique_scattered_lookup.cpp.csv         "Scattered unsuccessful lookup, Fmax=5, G=5" "vs/scattered unsuccessful looukp.xlsx" "practice non-unique 5"
