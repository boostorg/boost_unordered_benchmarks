...
python2 insert_data.py vs-x64/string.cpp.txt      README.md
python2 insert_data.py vs-x64/string_view.cpp.txt README.md
python2 insert_data.py vs-x64/uint32.cpp.txt      README.md
python2 insert_data.py vs-x64/uint64.cpp.txt      README.md
python2 insert_data.py vs-x64/uuid.cpp.txt        README.md
python2 insert_data.py vs-x64/word_count.cpp.txt  README.md
python2 insert_data.py vs-x64/word_size.cpp.txt   README.md
...
python2 insert_data.py vs-x86/string.cpp.txt      README.md
python2 insert_data.py vs-x86/string_view.cpp.txt README.md
python2 insert_data.py vs-x86/uint32.cpp.txt      README.md
python2 insert_data.py vs-x86/uint64.cpp.txt      README.md
python2 insert_data.py vs-x86/uuid.cpp.txt        README.md
python2 insert_data.py vs-x86/word_count.cpp.txt  README.md
python2 insert_data.py vs-x86/word_size.cpp.txt   README.md
