...
python2 insert_data.py vs-x64/running_insertion.cpp.csv "Running insertion"             "vs-x64/Running insertion.xlsx"             "plot"
python2 insert_data.py vs-x64/running_erasure.cpp.csv   "Running erasure"               "vs-x64/Running erasure.xlsx"               "plot"
python2 insert_data.py vs-x64/scattered_lookup.cpp.csv  "Scattered successful lookup"   "vs-x64/Scattered successful looukp.xlsx"   "plot"
python2 insert_data.py vs-x64/scattered_lookup.cpp.csv  "Scattered unsuccessful lookup" "vs-x64/Scattered unsuccessful looukp.xlsx" "plot"
...
python2 insert_data.py vs-x86/running_insertion.cpp.csv "Running insertion"             "vs-x86/Running insertion.xlsx"             "plot"
python2 insert_data.py vs-x86/running_erasure.cpp.csv   "Running erasure"               "vs-x86/Running erasure.xlsx"               "plot"
python2 insert_data.py vs-x86/scattered_lookup.cpp.csv  "Scattered successful lookup"   "vs-x86/Scattered successful looukp.xlsx"   "plot"
python2 insert_data.py vs-x86/scattered_lookup.cpp.csv  "Scattered unsuccessful lookup" "vs-x86/Scattered unsuccessful looukp.xlsx" "plot"